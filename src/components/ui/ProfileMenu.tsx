...
export default function ProfileMenu({ lang, setLang, translations, onOpenSuggestionModal }: ProfileMenuProps) {
  ...
  // Profil verisini FrameProvider'dan alıyoruz
      ...
      {isDropdownOpen && (
        <div className="absolute top-12 right-0 w-72 bg-card border border-border rounded-lg shadow-lg z-10 py-2">
          ...
          <div className="px-2 py-2 border-b border-border">
             <button 
                onClick={() => { onOpenSuggestionModal(); setIsDropdownOpen(false); }}
                className="w-full flex items-center space-x-2 px-2 py-2 rounded-md hover:bg-muted text-sm font-medium text-base-blue-500"
             >
